  ...
  return (
    <>
      ...
      <main>
        ...
        {/*  */}
        <section className=" w-[90%] mx-auto my-14 flex flex-col gap-6 justify-center items-center">
          <h1 className=" font-bold text-3xl text-black text-center">Subscribe to Our <span className=" text-primary">Blog</span></h1>
          <div className=" relative w-[90%] mx-auto">
            <input type="email" placeholder="enter email address" className=" rounded-2xl shadow-info px-4 py-6 w-full text-base border-none " />
            <ActionButton text={"Subscribe"} className={'text-white text-lg p-2 rounded-md absolute top-[20%] right-[5%]'}/>
          </div>
        </section>
