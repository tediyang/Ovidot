...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col flex-wrap gap-2 bg-[linear-gradient(135deg,#4D0B5E,#0013FF)] -mx-5 md:-mx-8 lg:-mx-10 px-5 md:px-8 lg:px-10 py-10 text-white text-xs">
      <section className="flex flex-col justify-between flex-wrap sm:flex-row gap-5 bg-[linear-gradient(135deg,#4D0B5E,#0013FF)] -mx-5 px-5 pb-10 text-white text-xs">
