...
const SigninImage = () => {
  return (
    <div
      className="lg:basis-1/2 flex flex-col justify-center items-center relative bg-cover bg-center bg-no-repeat min-h-full lg:min-h-[47.5rem] xl:rounded-tl-3xl xl:rounded-bl-3xl w-[100dvw] lg:max-w-[55rem]"
